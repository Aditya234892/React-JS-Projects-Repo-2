...
function CardList(props) {
  ...
  return (
    <div ref={dropRef} className={`bg-white h-fit rounded-lg shadow-md p-4 w-full max-w-xs ${isOver ? 'bg-gray-200' : 'bg-white'} sm:w-72`}>
      ...
      {showAddCard ? (
        ...
        <span onClick={onAddCardClick} className="text-blue-500 cursor-pointer">+ Add another chore</span>
      )}
    </div>
  );
}
