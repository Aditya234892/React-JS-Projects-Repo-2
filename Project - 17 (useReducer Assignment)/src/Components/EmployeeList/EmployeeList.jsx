...
function EmployeeList(props) {
  return (
    <div className="employeeList-card flex flex-col gap-2 p-4 mt-3 mb-3 w-2/5 rounded-lg shadow-md bg-orange-400">
      <h1 className="text-2xl text-center font-extrabold text-blue-900">All Players List</h1>
      {props.data.map((employee) => (
        ...
        >
          <div className="flex-grow">
            <h3 className="text-lg font-medium text-green-600">{`${employee.first_name} ${employee.last_name}`}</h3>
